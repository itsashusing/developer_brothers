            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Mobile</th>
                        <th>Address</th>
                        <th class="text-center">FO Details</th>
                        <th>Created Time </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <div class="d-flex gap-2">
                                    <div class="fw-bold">Fo ID</div>{{$lead->FO->fo_code}}
                                </div>
                                <div class="d-flex gap-2">
                                    <div class="fw-bold">Name</div> {{$lead->FO->name}}
                                </div>
                                <div class="d-flex gap-2">
                                    <div class="fw-bold">Mobile</div> {{$lead->FO->mobile}}
                                </div>
                            </div>
                        ...
                        <td><a class="btn btn-warning btn-sm" href="{{route('editleads',$lead->id)}}">Edit</a></td>
                    </tr>
                    @endforeach
